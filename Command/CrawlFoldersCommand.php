<?php
namespace Jcc\Bundle\AlbumBundle\Command;
...
use Jcc\Bundle\AlbumBundle\Entity\Folder;
...
class CrawlFoldersCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ...
            ->addOption('depth', 'd', InputOption::VALUE_OPTIONAL, null)
        ;
    }
    ...
    private function crawlFolders($root, $depth)
    {
        ...
        foreach ($paths as $path) {
            ...
            $folderService->crawlFolderPictures($folder);
        }
    }
}
